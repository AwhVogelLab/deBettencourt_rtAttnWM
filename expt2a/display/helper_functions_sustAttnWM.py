...
def get_specs(subj_name='mmddyyn_wmLoadMem02'):
    ...
    dictDlg = gui.DlgFromDict({'Participant number': '05dd181_sustAttnWM03',     #subject name: month, day, year, number, and project name
                                'Environment':['imac','booth','edslab'],    #which environment (aka monitor name in Tools > Monitor Center)
    ...
    if gui_specs['env']=='imac':
        gui_specs['project_dir']='/Users/megan/Documents/projects/sustAttnWM03/'
    elif gui_specs['env']=='booth':
        gui_specs['project_dir']='C:/Users/AwhVogelLab/Desktop/Megan/sustAttnWM03/'
    elif gui_specs['env']=='edslab':
        gui_specs['project_dir']='/Users/edslab/Documents/projects/sustAttnWM03/'
    else:
