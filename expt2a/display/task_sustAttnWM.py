            ...
            if response is None:
                ...
                if response is not None:
                    ...
                    if itrial>=self.dsgn.n_trials_atstart:
                        ...
                        self.dsgn.rts_runningslowthresh[iblock,itrial] = self.dsgn.rts_runningavg[iblock,itrial]+self.dsgn.rts_runningstd[iblock,itrial]
                        self.dsgn.rts_runningfastthresh[iblock,itrial] = self.dsgn.rts_runningavg[iblock,itrial]-self.dsgn.rts_runningstd[iblock,itrial]
                        self.dsgn.rts_trailingavg[iblock,itrial] = np.nanmean(self.dsgn.rts[iblock,(itrial-2):(itrial+1)])
                        
                        #print self.dsgn.rts[iblock,(itrial-self.dsgn.probetrials_dist):(itrial+1)]
                        #print self.dsgn.rts[iblock,itrial]
                        #print self.dsgn.rts[iblock,itrial]>self.dsgn.rts_runningslowthresh[iblock,itrial], self.dsgn.rts[iblock,itrial]<self.dsgn.rts_runningfastthresh[iblock,itrial]
                        #print self.dsgn.freq_trials[iblock,itrial]==1,~np.any(self.dsgn.rts[iblock,(itrial-self.dsgn.probetrials_dist):(itrial)] == np.nan), np.all(self.dsgn.probe_trials[iblock,(itrial-self.dsgn.probetrials_dist):itrial] == 0)
                        if self.dsgn.freq_trials[iblock,itrial]==1 and ~np.any(self.dsgn.rts[iblock,(itrial-self.dsgn.probetrials_dist):(itrial+1)] == np.nan) and np.all(self.dsgn.probe_trials[iblock,(itrial-self.dsgn.probetrials_dist):itrial] == 0):
                            ...
                            if self.dsgn.rts_trailingavg[iblock,itrial]>self.dsgn.rts_runningslowthresh[iblock,itrial] and np.nansum(self.dsgn.rt_triggered_slow[iblock,0:itrial])<self.dsgn.n_rt_triggered_slow:
                                ...
                                #print "TRIGGERED SLOW", np.nansum(self.dsgn.rt_triggered_slow[iblock,0:itrial])
                            ...
                            if self.dsgn.rts_trailingavg[iblock,itrial]<self.dsgn.rts_runningfastthresh[iblock,itrial] and np.nansum(self.dsgn.rt_triggered_fast[iblock,0:itrial])<self.dsgn.n_rt_triggered_fast:
                                ...
                                #print "TRIGGERED FAST", np.nansum(self.dsgn.rt_triggered_fast[iblock,0:itrial])

                        if self.dsgn.rt_triggered_slow[iblock,itrial] == 1 or self.dsgn.rt_triggered_fast[iblock,itrial] == 1:
                            self.dsgn.rt_triggered[iblock,itrial] = 1
                            self.dsgn.probe_trials[iblock,itrial] = 1
                            #print "TRIGGERED"
